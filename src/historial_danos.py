# historial_danos.py
# Ventana para consultar el historial de daños a equipos
...
from modules.historial_danos_logic import buscar_danos
from modules.equipos import obtener_todos_equipos
from modules.sesion import Sesion


class HistorialDanños(QWidget):
    def __init__(self):
        super().__init__()
        ...
        self.setWindowTitle("Historial de Daños - Institución Educativa del Sur")
        self.showFullScreen()
...
""")
        ...
        # Sección título
        seccion_titulo = QLabel("Historial de Daños")
        ...
        self.txt_estudiante.setPlaceholderText("Ingrese nombre o apellido...")

        lbl_grado = QLabel("🏫 Grado:")
        lbl_grado.setStyleSheet("color: #E3F2FD; font-weight: bold;")
        self.cmb_grado = QComboBox()
        from modules.equipos import obtener_grados
        self.cmb_grado.addItems([""] + obtener_grados())
        ...
        """)
        self.btn_buscar.clicked.connect(self.buscar_danos_ui)
        ...
        # Tabla
        titulo_tabla = QLabel("Daños Registrados")
        ...
        lbl_no = QLabel("No se encontraron daños registrados")
    ...
    def buscar_danos_ui(self):
        ...
        resultados = buscar_danos(nombre, grado, equipo, fecha)
